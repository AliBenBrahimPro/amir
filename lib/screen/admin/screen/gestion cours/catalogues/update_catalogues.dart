...
class EditCatalogue extends StatefulWidget {
  final Catalogues catalogues;
  const EditCatalogue({super.key, required this.catalogues});
...
class _EditCatalogueState extends State<EditCatalogue> {
  @override
  void initState() {
    nameController.text = widget.catalogues.nameCatalogue;
    yearController.text = widget.catalogues.collegeYear;
    super.initState();
  }
