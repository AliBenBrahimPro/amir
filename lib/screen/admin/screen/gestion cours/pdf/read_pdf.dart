...
class _ReadPdfState extends State<ReadPdf> {
  ...
  void _sortNew(String ascending) {
    ...
    setState(() {
      results = users
          .where((user) => user.file.toLowerCase().contains(ascending))
          .toList();
      log(results.map((e) => e.file).toString());
      setState(() {
        _foundInfo = results;
      });
    });
  ...
  getData() async {
    users = await pdfController.getAllPdf();
    setState(() {
      isLoaded = false;
      _foundInfo = users;
    });
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          title: const Text("Gestion de pdf"),
        ),
                      ...
                      return ListTile(
                        ...
                        trailing: Row(
                          ...
                          children: [
                            ...
                            IconButton(
                                onPressed: () {
                                  pdfController.deletePdf(item.id);
                                  setState(() {
